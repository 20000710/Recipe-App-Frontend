    ...
    <div className="card text-center myrecipe-card">
        ...
        <ul className="nav nav-tabs card-header-tabs">
          ...
          <li className="nav-item">
            <a
              className="nav-link"
              id="saved-recipe"
              onClick={() => setNavigate("saved-recipe")}
              href="#saved-recipe"
            >
              Saved Recipe
            </a>
          ...
          <li className="nav-item">
            <a
              className="nav-link"
              id="liked-recipe"
              onClick={() => setNavigate("liked-recipe")}
              href="#liked-recipe"
            >
              Liked Recipe
            </a>
      ...
      <div className="card-body">
        {navigate === "my-recipe" ? (
          ...
          savedRecipe !== "you dont have saved recipe" ? (
          <div id="saved-recipe">
            <img
              src={myRecipe2}
              class="img-fluid"
        ...
        ) : navigate === "liked-recipe" &&
          likedRecipe !== "you dont have liked recipe" ? (
          <div id="liked-recipe">
            <img
              src={myRecipe1}
              class="img-fluid"
